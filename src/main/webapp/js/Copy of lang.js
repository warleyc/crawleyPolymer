...
$(function() {
		...
		$( "a#uk" ).click(function() {
            ...
            $("#p1").text("Welcome on nicolas CRAWLEY personal website");
            $("#p2").text("Project manager and Web consultant, here are the various projects, I attended and information to contact me.");
